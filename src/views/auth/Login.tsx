...
export default function Login() {
    ...
    return <Column style={{width: "100%", height: "100%", alignItems: "center", justifyContent: "center"}}>
        <Column style={{gap: "10px", width: "100%", maxWidth: "400px", padding: "0 15px", boxSizing: "border-box"}}>
            ...
            <TextField onSubmit={onLogin} onChange={onChange} value={state.username} name={"username"}
                       caption={"Нэвтрэх нэр"}/>
            <TextField onSubmit={onLogin} onChange={onChange} value={state.password} name={"password"}
                       caption={"Нууц үг"}
                       type={"password"}/>
